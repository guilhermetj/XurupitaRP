		...
		if IsControlJustPressed(0,344) then
			...
			if identity then
				...
				local html = string.format("<div id='DocumentSection'><div class='avatar-img'><img src='%s'></div> <div class='infos'><div class='main-info'>"..
					...
					"<div class='clear'></div>"..
					"<div class='each-info'><strong>VIP:</strong><span class='person-nvip'>%s</span></div>"..
					"<div class='clear'></div>"..
					"<div class='each-info'><strong>Tempo:</strong><span class='person-datavip'>%s</span></div>"..
					"<div class='clear'></div>"..
					"</div>"..
					"</div>"..
					"</div>", foto, name, firstname, age, groupname, user_id, registration, phone, carteira, banco, multas, tem, tema, nvip, datavip)
