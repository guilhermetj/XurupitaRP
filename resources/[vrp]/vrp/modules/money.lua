...
local webhooklink1 = "https://discordapp.com/api/webhooks/738494736645750834/WAEMJ4O3G4UDxG9dw4m1B9LhrUjcPz3VC19sXs9WkMRsJySfQm_Ag48hXex55Ih5aRXB"
...
AddEventHandler("vRP:playerJoin",function(user_id,source,name)
	vRP.execute("vRP/money_init_user",{ user_id = user_id, wallet = 5000, bank = 45000 })
	local tmp = vRP.getUserTmpTable(user_id)
	if tmp then
